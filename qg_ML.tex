...
\begin{figure}[t]
	   ...
	   \caption{Top: Distributions of groomed momentum sharing $z_g$ (left) and TD subjet momentum  $z_{\rm T2}$ (right); Bottom: Distributions of groomed jet radius $r_g$ and the TD angular separation between subjets $\theta_{\rm T2}$ for of quark (blue) and gluon (red) jets in pp \jw simulations.}
\label{fig:comp_z_pp_wT2}
\end{figure}

\begin{figure}[t]
	   \centering
	   \caption{Distributions of groomed jet radius $r_g$ and TD subjet momentum  $z_{\rm T2}$ of quark (blue) and gluon (red) jets in pp.}
\label{fig:comp_z}
\end{figure}
...
\begin{figure}[t]
	   ...
	   \caption{Distributions of TD $\lambda$, which is the ratio between subjet mass and subjet $p_T$, for quark (left) and gluon (right) jets in pp (solid and dashed lines) and centra PbPb (dotted and dot-dashed lines) collisions in \jwpy. }
